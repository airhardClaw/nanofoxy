...
logger.add("~/.nanobot/workspace/logs/{time}/agent-loop.log", rotation="1day")
...
class AgentLoop:
    ...
    def _register_default_tools(self) -> None:
        ...
        for cls in (WriteFileTool, EditFileTool, ListDirTool, ListFileBackupsTool, RestoreFileBackupTool):
